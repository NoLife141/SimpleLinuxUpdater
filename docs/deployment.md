...
```bash
docker run --env-file .env -p 8080:8080 -v debian-updater-data:/data ghcr.io/nolife141/simplelinuxupdater:v0.2.3
```
...
```bash
docker pull ghcr.io/nolife141/simplelinuxupdater:v0.2.3
```
